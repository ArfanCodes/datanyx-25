...
const API_URL = process.env.EXPO_PUBLIC_RAG_API_URL || 'https://finstability-api-v2-120470301005.asia-south1.run.app/chat_coach';
...
export const ragService = {
    sendMessage: async (message: string, riskScore: number = 0): Promise<string> => {
        try {
            const payload = {
                message,
