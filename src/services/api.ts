...
const DEV_API_URL = process.env.EXPO_PUBLIC_DEV_API_URL || Platform.select({
...
const PROD_API_URL = process.env.EXPO_PUBLIC_PROD_API_URL || 'https://your-production-app.railway.app/api';
